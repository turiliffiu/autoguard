...
#define MQTT_DEVICE_NAME         "AutoGuard"
#define MQTT_DEVICE_ID           "autoguard_001"
#define MQTT_DEVICE_MODEL        "ESP32-C6 + HLK-LD2420"
#define MQTT_DEVICE_MANUFACTURER "AutoGuard"
